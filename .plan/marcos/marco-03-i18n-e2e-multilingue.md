...
| ---------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------- |
| i18n e E2E multilíngue | [`../issues/issue-003-i18n-e2e-multilingue.md`](../issues/issue-003-i18n-e2e-multilingue.md) | [Issue #4](https://github.com/Malnati/xadrez/issues/4) | [Project 14](https://github.com/users/Malnati/projects/14/) | [PR #5](https://github.com/Malnati/xadrez/pull/5) |
...
- PR GitHub: [PR #5](https://github.com/Malnati/xadrez/pull/5).
